from tkinter import Frame, Label, Scrollbar, Text, Tk
...
def toggle_textbox(event):
    ...
    if isinstance(getattr(compiler, selected_item, None), type(None)):
        ...
        first_frame_subframe1.delete(*first_frame_subframe1.get_children()) #Delete all existing rows before hiding it.
